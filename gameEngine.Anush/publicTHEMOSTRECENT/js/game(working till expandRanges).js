...
function buildBricks(level, tiles, patterns){  // Iterate through the Json file reading the dimensions of the x's anmd
...
function drawLevel(name) { // draw Level function to read Json files 
    ...
    .then(function([levelDetails,pixels]){
        ...
        buildBricks(level,levelDetails.tiles, levelDetails.patterns);
...
.then(function([createPlayer,level]){
